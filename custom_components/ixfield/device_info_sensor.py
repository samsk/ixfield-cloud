        ...
        if address_info.get("postal_code"):
            sensors.append(
                DeviceInfoSensor(
                    ...
                    device_id,
                    device_name,
                    "device_address_postal_code",
                    "Device Address Postal Code",
    ...
    if device_info.get("in_operation_since"):
        sensors.append(
            DeviceInfoSensor(
                ...
                device_id,
                device_name,
                "device_in_operation_since",
                "In Operation Since",
                device_info.get("in_operation_since"),
                "mdi:clock-start",
            )
        )
...
class DeviceInfoSensor(CoordinatorEntity, SensorEntity, EntityNamingMixin):
    ...
    def __init__(
        self, coordinator, device_id, device_name, sensor_id, sensor_name, value, icon
    ):
